...
exports.AttachmentDownloadsApi = void 0;
/*
 ...
 */
exports.AttachmentDownloadsApi = {
     ...
     */
    fileDownloadWithUniqueId: (uniqueAttachmentId, queryParameters) => new openapi_1.OpenApiRequestBuilder('get', '/attachment/{uniqueAttachmentId}', {
        pathParameters: { uniqueAttachmentId },
        queryParameters
    }, exports.AttachmentDownloadsApi._defaultBasePath),
    /**
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    fileDownloadWithApprovableAndAttachmentId: (queryType, approvableId, attachmentId, queryParameters) => new openapi_1.OpenApiRequestBuilder('get', '/{queryType}/{approvableId}/attachments/{attachmentId}', {
